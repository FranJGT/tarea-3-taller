...
% --- Configuración de Colores palera Deep Ocean ---
...
\begin{frame}[plain]
    ...
    \vspace{1.5cm}
        ...
        \large \textbf{Grupo: IA India de Hevia}\\[0.2cm]
        \small Integrantes:\\
        Benjamín Camus\\
        Nicolás Armijo\\
        Francisco González\\
...
% --- Proceso Empresarial ---
\begin{frame}{Fase 2. Proceso Empresarial (Videojuegos e IA)}


        % -------------------- OBJETIVO ESTRATÉGICO --------------------
        \begin{premiumbox}{Objetivo Estratégico}
            \small ¿Qué busca el negocio con IA dentro del videojuego?
            \begin{itemize}
                \item Crear un \textbf{comportamiento inteligente competitivo} que mejore la experiencia del jugador.
                \item Reducir costos de diseño manual de niveles mediante \textbf{automatización del comportamiento enemigo}.
                \item Incorporar IA que diferencie el producto frente a la competencia (mayor \textbf{engagement}).
            \end{itemize}
        \end{premiumbox}
...
\begin{frame}
            % -------------------- OBJETIVO OPERATIVO --------------------
        \begin{premiumbox}{Objetivo Operativo}
            \small ¿Cómo se implementará la IA dentro del proceso de producción?
            \begin{itemize}
                \item El agente REINFORCE decide la navegación óptima en un \textbf{mapa estilo dungeon / arena}.
                \item Integración con el motor de juego (Unity/Unreal) mediante una capa de \textbf{estado–acción}.
                \item Entrenamiento autónomo con más de \textbf{10.000 simulaciones internas} por episodio.
            \end{itemize}
        \end{premiumbox}

        \vspace{0.2cm}
                % --------------------ENTORNO --------------------
        \begin{premiumbox}{Relación con el entorno}
            \small El entorno de 9x9 simula:
            \begin{itemize}
                \item Toma de decisiones en mapas con \textbf{obstáculos}, rutas alternativas y objetos.
                \item Un sistema de recompensas comparable a la \textbf{economía interna de un videojuego}.
                \item Un jugador/enemigo que prioriza eficiencia y evita situaciones de riesgo.
            \end{itemize}
        \end{premiumbox}
\end{frame}
